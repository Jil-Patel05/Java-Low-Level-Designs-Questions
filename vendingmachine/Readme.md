...
1. No need to support Multi-threading as we have considered machine, at a time machine have only one Person handling thing
2. For each state only use 2 method, nextState and giveStateName, as for all other types of operations each State would be not implemented many things
